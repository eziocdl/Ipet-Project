            ...
            <div class="div_main">
                <div class="div_sec">
                    ...
                    <div class="titulo" style="padding-top: 30px;padding-bottom: 5px;">
                        <p> <b>Olá, '.$nome_dono_pet.'</b> </p>
                        <p>Recebemos novas informações do seu querido Pet '.$nome_pet.', como o contato não é cadastrado em nossa plataforma, segue os dados do contato.</p>
                        <p style="text-align:left;" >E-mail: '.$email_achou.'</p>
                        <p style="text-align:left;" >Telefone: '.$tel.'</p>
                        <p style="text-align:left;" >Mensagem: '.$msn.'</p>
                    </div>  
                    <div style="padding-top: 0px;padding-bottom: 0px;text-align: left;padding-left: 20px;padding: 20px;color: #686667;">
                        <p style="text-align:center; color:red; font-size:18px;">Tenha cuidado ao entrar em contato com pessoas que ainda não se cadastraram na plataforma.</p>
                    </div>                                
